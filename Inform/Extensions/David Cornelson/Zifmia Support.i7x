Version 1/110815 of Zifmia Support (for Glulx only) by David Cornelson begins here.
...
To End the game:
	select the end game channel;
	say "xyzzy";
	select the main channel;
	end the game saying "Good Bye!".
...
Chapter 6 - HTML/CSS Phrases

[
	I'm still unhappy with this code. I'm nearly positive there should be no HTML in I7.

A text-style is a kind of thing. It has some text called the name.

To say span (span - text-style):
	say "<span class='[name of span]'>".
	
To say end span:
	say "</span>".
	
To say div (div - text-style):
	say "<div class='[name of div]'>".
...
[
	These phrases are done in jQuery. The zifmia-htmlformatter takes care of the translation.
]
To say embed (F - a figure name) on the left: say "{'refId:','[reference of F]','align:','left','container:','paragraph','alternateText:','[F]'}".
To say embed (F - a figure name) on the right: say "{'refId:','[reference of F]','align:','right','container:','paragraph','alternateText:','[F]'}".
To say place (F - a figure name) on the left: say "{'refId:','[reference of F]','align:','left','container:','page','alternateText:','[F]'}".
To say place (F - a figure name) on the right: say "{'refId:','[reference of F]','align:','right','container:','page','alternateText:','[F]'}".
To say popup (F - a figure name): say "{'refId:','[reference of F]','align:','popup','container:','page','alternateText:','[F]'}".
To say set background (F - a figure name) on the left: say "{'refId:','[reference of F]','align:','left','background:','true','alternateText:','[F]'}".
To say set background (F - a figure name) on the right: say "{'refId:','[reference of F]','align:','right','background:','true','alternateText:','[F]'}".
To say set background (F - a figure name) in the center: say "{'refId:','[reference of F]','align:','center','background:','true','alternateText:','[F]'}".
To say set background (F - a figure name) for the page: say "{'refId:','[reference of F]','align:','page','background:','true','alternateText:','[F]'}".
]
...
Zifmia Support ends here.

---- DOCUMENTATION ----

Zifmia is a client/server Glulx engine that uses Channel IO to provide authors with the capability of designing their own user interface in browser-based technologies (like HTML, CSS, and jQuery).
...
3. Use a client-side template that knows what to do with any output found on the new channel. Currently, new templates will need to be developed in partnership with Textfyre, but the long-term goal is to provide an upload or IFRAME mechanism to accommodate new templates.
...
For more information, screen shots, and examples, please visit "http://www.zifmia.org".
